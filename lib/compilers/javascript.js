...
var Compiler = (function () {
    ...
    Compiler.prototype.compileTemplate = function (node) {
        ...
        try  {
            ...
            var column = this.line() === 1 ? e.column + node.body.column : e.column;
    ...
    Compiler.prototype.escapeValue = function (node) {
        switch (node.type) {
            ...
            case 'Code':
                return node.value;
            default:
                throw new ICError('Unknown value type: ' + node.type, this.filename, this.line());
        }
    };

    Compiler.prototype.line = function () {
