...
var fixture = function(name){ return path.join(__dirname,'fixtures','tag',name); };
...
describe('Tags', function(){
    ...
    it('create div with attributes', function(){
        ...
        expect(input.getAttribute('data-short')).toEqual('short');
        expect(input.getAttribute('data-long')).toEqual('long');
    });
